<template>
  <div class="block">
    <el-divider>
      <div class="title">Kandungan dan Proses Perkhidmatan</div>
    </el-divider>
    ...
    <el-divider>
      <div class="title">Proses Perkhidmatan</div>
    </el-divider>
    <div class="center-box" style="text-align:center;margin-top:40px">
      ...
      <el-steps :active="4" simple>
        <el-step title="Proses penuh pengambilan" icon="el-icon-edit"></el-step>
        <el-step
          title="Penutupan penuh jawatan"
          icon="el-icon-s-custom"
        ></el-step>
        <el-step
          title="Pengurusan saluran"
          icon="el-icon-refresh-right"
        ></el-step>
        <el-step
          title="Kawalan penuh proses"
...
.center-box .el-step__head.is-finish {
  color: #606ecd;
}
.center-box .el-step.is-simple .el-step__title {
  font-size: 20px;
}
</style>
<style scoped>
